<footer class="relative z-10 bg-rani-dark text-white pt-16 pb-8 border-t-4 border-rani-gold mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2 text-rani-gold-light/70">
                    <li><a href="{{ route('privacy.policy') }}" class="hover:text-rani-gold transition-colors">Support</a></li>
                    <li><a href="{{ route('privacy.policy') }}" class="hover:text-rani-gold transition-colors">Help Center</a></li>
            ...
            <div>
                <h3 class="text-lg font-serif font-bold mb-4 text-rani-gold">Connect With Us</h3>
                <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-rani-gold text-rani-gold-light hover:text-rani-primary-dark transition-all duration-300">
