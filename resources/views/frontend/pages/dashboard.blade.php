    ...
    <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all hover:shadow-md">
                <div class="p-6 flex flex-col items-center border-b border-gray-100 relative">
                    ...
                    <div class="relative mb-4">
                        ...
                        @if($candidate->selfie_verified || ($candidateBluetick && $candidateBluetick->is_accept === 1))
                            <div class="absolute bottom-1 right-1 bg-green-500 text-white rounded-full p-1.5 border-2 border-white shadow-md flex items-center justify-center" title="Blue Tick Verified Profile">
                ...
                <div class="p-4 flex justify-between items-center bg-green-50/50">
                    <div>
                        ...
                        <p class="text-[11px] text-gray-500">Blue Tick Active</p>
                    </div>
                    <div class="flex items-center gap-1.5 text-emerald-700 bg-emerald-100 px-2.5 py-1 rounded-full text-xs font-bold shadow-xs">
        ...
        <div class="w-full lg:w-2/4 flex flex-col gap-6">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 flex flex-col sm:flex-row items-center gap-6 bg-gradient-to-r from-emerald-50 via-teal-50 to-green-50">
                    <div class="relative shrink-0">
                        <div class="w-20 h-20 rounded-full bg-white shadow-md flex items-center justify-center border-4 border-emerald-200">
                            <svg class="w-10 h-10 text-emerald-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        </div>
                    </div>
                    <div class="text-center sm:text-left flex-1">
                        <div class="flex items-center justify-center sm:justify-start gap-2 mb-1">
                            <h4 class="font-bold text-gray-800 text-lg">Blue Tick Verified</h4>
                            <span class="bg-emerald-100 text-emerald-800 text-xs px-2 py-0.5 rounded-full font-bold">100% Genuine</span>
                        </div>
                        ...
                        <a href="{{ route('my-photos') }}" class="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-800 bg-white border border-emerald-200 px-4 py-2 rounded-xl hover:bg-emerald-50 transition-colors shadow-xs">
