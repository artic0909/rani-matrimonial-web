...
<div class="relative bg-gradient-to-b from-rani-light via-white to-rani-light/40 py-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-4xl mx-auto text-center mb-12">
        ...
        <p class="text-base sm:text-lg text-gray-600 font-light max-w-2xl mx-auto">
            Please read these terms and conditions carefully before registering or using services offered on <strong class="text-gray-800 font-semibold">Rani Matrimonial</strong>, managed by <strong class="text-gray-800 font-semibold">Sumatra Sales Private Limited</strong>.
        </p>
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-10 lg:p-12 relative overflow-hidden">
        ...
        <div class="prose prose-slate max-w-none space-y-10 text-gray-700 leading-relaxed font-sans">
            ...
            <section class="border-b border-gray-100 pb-8">
                <h2 class="text-2xl font-serif font-bold text-rani-primary-dark mb-4 flex items-center gap-3">
                    <span class="flex items-center justify-center w-8 h-8 rounded-lg bg-rani-light text-rani-primary text-sm font-bold">3</span>
            ...
            <section class="border-b border-gray-100 pb-8">
                ...
                <div class="bg-amber-50/70 border border-amber-200 p-5 rounded-xl mb-4 text-sm text-amber-900">
            ...
            <section class="border-b border-gray-100 pb-8">
                ...
                <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl text-sm leading-relaxed text-gray-700 space-y-3">
                    <p>
            ...
            <section class="border-b border-gray-100 pb-8">
                <h2 class="text-2xl font-serif font-bold text-rani-primary-dark mb-4 flex items-center gap-3">
                    <span class="flex items-center justify-center w-8 h-8 rounded-lg bg-rani-light text-rani-primary text-sm font-bold">8</span>
            ...
            <section class="border-b border-gray-100 pb-8">
                <h2 class="text-2xl font-serif font-bold text-rani-primary-dark mb-4 flex items-center gap-3">
                    <span class="flex items-center justify-center w-8 h-8 rounded-lg bg-rani-light text-rani-primary text-sm font-bold">9</span>
            ...
            <section class="bg-rani-primary text-white p-6 sm:p-8 rounded-2xl">
                <h2 class="text-xl font-serif font-bold text-rani-gold mb-3">
                    10. Customer Support & Corporate Information
                </h2>
