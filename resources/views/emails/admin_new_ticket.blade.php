...
<head>
    ...
    <title>New Support Ticket - Rani Matrimonial</title>
    <style>
        ...
        .ticket-code-card { background: linear-gradient(135deg, #fffdf8 0%, #fef8eb 100%); border: 2px solid #d4af37; border-radius: 14px; padding: 16px; text-align: center; margin: 16px 0; box-shadow: 0 4px 14px rgba(212, 175, 55, 0.12); }
        .ticket-code-val { font-family: 'Courier New', Courier, monospace; font-size: 22px; font-weight: 900; color: #750000; letter-spacing: 2px; }
    ...
    <div class="wrapper">
        <div class="email-container">
            <div class="header">
                ...
                <div class="header-badge">Admin Ticket Notification</div>
                <h1>New Ticket Raised</h1>
                <p>A candidate has requested support assistance</p>
            </div>
            <div class="content">
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td class="info-val"><strong>{{ $candidate->first_name }} {{ $candidate->last_name }}</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="info-val">
                            {{ !empty($ticket->screenshots) ? count($ticket->screenshots) . ' Screenshot(s) attached' : 'None' }}
                        </td>
                    </tr>
                </table>

                <div style="font-size: 13px; font-weight: 700; color: #4a0404;">Ticket Message:</div>
                <div class="message-box">
                    {!! nl2br(e($ticket->message)) !!}
                </div>

                <a href="{{ url('/admin/tickets') }}" class="btn-action">
                    Open Ticket in Admin Desk →
                </a>
            </div>
            <div class="footer">
