...
@section('title', 'Basic Table - Spark Admin Premium Bootstrap 5 Admin Dashboard Template')
...
<!-- END: Top Navbar Component -->
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Highly customizable, responsive tabular data component templates.</p>
      </div>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item active text-main" aria-current="page">Basic Tables</li>
        </ol>
      </nav>
    </div>
        ...
        <table class="table-custom">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_1.jpg') }}" alt="Eleanor Pena" class="table-user-avatar"
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_2.jpg') }}" alt="Wade Warren" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_3.jpg') }}" alt="Jane Cooper" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_4.jpg') }}" alt="Robert Fox" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_5.jpg') }}" alt="Albert Flores" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_6.jpg') }}" alt="Kristin Watson" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_7.jpg') }}" alt="Cody Fisher" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_8.jpg') }}" alt="Bessie Cooper" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_1.jpg') }}" alt="Dianne Russell" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
            ...
            <tr>
              ...
              <td>
                <div class="table-user-cell">
                  <img src="{{ asset('admin/images/user_2.jpg') }}" alt="Devon Lane" class="table-user-avatar"
                    onerror="this.src='assets/images/avatar.png'">
                  <div>
