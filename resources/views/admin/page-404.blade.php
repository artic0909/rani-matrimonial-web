...
<head>
    ...
    <title>404 Page Not Found - Spark Admin Premium Bootstrap 5 Admin Dashboard Template</title>
    
    <!-- SEO Optimization -->
    <meta name="description" content="404 Page Not Found - Spark Admin Premium Bootstrap 5 Admin Dashboard Template">
    ...
    <div class="login-wrapper">
        ...
        <div class="login-card text-center">
            ...
            <div class="error-actions-group">
                <a href="{{ route('admin.dashboard') }}" class="btn-custom btn-custom-primary">
