...
<div class="container-fluid p-0" id="master-crud-app">
    ...
    <div class="page-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <i class="bi {{ $config['icon'] }} fs-4" style="color: var(--brand-forest-medium);"></i>
                <h1 class="page-title mb-0">{{ $config['plural'] }}</h1>
                <span class="badge-table success ms-2" id="header-total-badge">
                    {{ number_format($totalRecords) }} Total
                </span>
            </div>
            <p class="page-subtitle mb-0">Browse, search, and manage standard system lookup options for {{ strtolower($config['plural']) }}.</p>
        </div>
        <div class="d-flex align-items-center gap-2">
            ...
            <button type="button" class="btn-custom btn-custom-primary btn-custom-sm" onclick="openCreateModal()">
    ...
    <!-- START: Main Data Table Container -->
    <div class="table-card-custom">
        ...
        <div class="table-header-control">
            <div class="d-flex flex-wrap align-items-center gap-2.5 flex-grow-1">
                <!-- Search Box -->
                <div class="table-search-box m-0" style="max-width: 320px; min-width: 240px;">
                ...
                <div style="min-width: 220px; max-width: 280px;">
                    <select id="filter-parent" class="form-select select2" data-placeholder="All {{ $config['parent_label'] ?? 'Parents' }} (All)">
            ...
            <div class="d-flex align-items-center gap-2 ms-auto">
                ...
                <select id="per-page-select" class="form-select form-select-sm bg-light w-auto border rounded-2" onchange="handlePerPageChange()">
        ...
        <div class="p-3 bg-white border-top d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 table-footer-control">
            <div class="table-user-sub" id="pagination-summary">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header border-bottom px-4 py-3 bg-light">
                <h5 class="modal-title fw-bold text-main" id="createMasterModalLabel">
                    <i class="bi bi-plus-circle me-1.5" style="color: var(--brand-forest-medium);"></i> Add New {{ $config['singular'] }}
                </h5>
            ...
            <form id="createMasterForm" onsubmit="handleCreateSubmit(event)">
                ...
                <div class="modal-body p-4">
                    <!-- Form Error Alert -->
                    <div class="alert alert-danger py-2 px-3 mb-3 small d-none rounded-3" id="create-modal-error">
                    ...
                    @if(!empty($config['has_parent']))
                    <div class="mb-3">
                        <label for="create_parent_id" class="form-label fw-semibold small text-main">
                    ...
                    <div class="mb-3">
                        <label for="create_name" class="form-label fw-semibold small text-main">
                ...
                <div class="modal-footer border-top px-4 py-3 bg-light">
                    ...
                    <button type="submit" class="btn-custom btn-custom-primary btn-custom-sm" id="btn-create-submit">
...
<div class="modal fade" id="editMasterModal" tabindex="-1" aria-labelledby="editMasterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="modal-header border-bottom px-4 py-3 bg-light">
                <h5 class="modal-title fw-bold text-main" id="editMasterModalLabel">
                    <i class="bi bi-pencil-square me-1.5" style="color: var(--brand-forest-medium);"></i> Edit {{ $config['singular'] }}
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editMasterForm" onsubmit="handleEditSubmit(event)">
                ...
                <div class="modal-body p-4">
                    <!-- Form Error Alert -->
                    <div class="alert alert-danger py-2 px-3 mb-3 small d-none rounded-3" id="edit-modal-error">
                        <i class="bi bi-exclamation-triangle-fill me-1"></i>
                    ...
                    @if(!empty($config['has_parent']))
                    <div class="mb-3">
                        <label for="edit_parent_id" class="form-label fw-semibold small text-main">
                            Select {{ $config['parent_label'] ?? 'Parent' }} <span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="mb-3">
                        <label for="edit_name" class="form-label fw-semibold small text-main">
                            {{ $config['singular'] }} Name <span class="text-danger">*</span>
                        </label>
                        <input type="text" 
                               name="name" 
                ...
                <div class="modal-footer border-top px-4 py-3 bg-light">
                    <button type="button" class="btn-custom btn-custom-light btn-custom-sm" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn-custom btn-custom-primary btn-custom-sm" id="btn-edit-submit">
...
<script>
    ...
    /**
     * Delete confirmation & execution using themed SweetAlert2
     */
                ...
                .then(({ ok, data }) => {
                    if (ok && data.success) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Cannot Delete',
                            text: data.message || 'This record cannot be deleted.'
                        });
                    }
                })
                .catch(err => {
